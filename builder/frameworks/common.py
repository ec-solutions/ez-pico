...
def dev_compiler(env, application_name = 'APPLICATION'):
    ...
    env.sdk = env.BoardConfig().get("build.sdk", "pico-sdk") # get/set default SDK
    ...
    ### pico w board
        ...
        env.Append(
            CPPPATH = [
                ...
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "apps", "altcp_tls"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "apps", "http"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "apps", "http", "fs"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "apps", "http", "makefsdata"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "apps", "snmp"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "compat", "posix"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "compat", "posix", "arpa"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "compat", "posix", "net"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "compat", "posix", "sys"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "compat", "stdc"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "lwip"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "lwip", "apps"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "lwip", "priv"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "lwip", "prot"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "netif"),
                join(env.framework_dir, env.sdk, "lib", "lwip", "src", "include", "netif", "ppp"),
                ...
                join(env.framework_dir, env.sdk, "src", "common", "pico_base", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_binary_info", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_binary_info", "include", "pico", "binary_info"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_bit_ops", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_divider", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_stdlib", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_sync", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "common", "pico_time", "include", "pico"),
                ...
                join(env.framework_dir, env.sdk, "src", "host", "hardware_timer", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "host", "hardware_uart", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "host", "pico_multicore", "include", "pico"),
                ...
                join(env.framework_dir, env.sdk, "src", "rp2_common", "cmsis", "stub", "CMSIS", "Core", "Include"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "cmsis", "stub", "CMSIS", "Device", "RaspberryPi", "RP2040", "Include"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_adc", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_base", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_claim", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_clocks", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_divider", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_dma", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_exception", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_flash", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_gpio", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_i2c", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_interp", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_irq", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_pio", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_pll", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_pwm", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_resets", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_rtc", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_spi", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_sync", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_timer", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_uart", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_vreg", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_watchdog", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "hardware_xosc", "include", "hardware"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_async_context", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_bootrom", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_bootrom", "include", "pico", "bootrom"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_btstack"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_btstack", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cxx_options"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cyw43_arch", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cyw43_arch", "include", "pico", "cyw43_arch"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cyw43_driver", "cybt_shared_bus"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cyw43_driver", "include"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_cyw43_driver", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_double", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_fix", "rp2040_usb_device_enumeration", "include", "pico", "fix"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_float", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_i2c_slave", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_int64_ops", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_lwip"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_lwip", "include", "arch"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_lwip", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_malloc", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_mem_ops", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_multicore", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_platform", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_printf", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_rand", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_runtime", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_standard_link"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio", "include", "pico", "stdio"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio_semihosting", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio_uart", "include", "pico"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio_usb", "include"),
                join(env.framework_dir, env.sdk, "src", "rp2_common", "pico_stdio_usb", "include", "pico"),
        ...
        WIFI_FIRMWARE_BIN = join(env.framework_dir, env.sdk, "lib", "cyw43-driver", "firmware", "w43439A0_7_95_49_00_combined")
